<%-- 
  ...
  - Description: BridgeGateway testing with password
--%>
<%@page import="java.util.UUID"%>
<%@page import="javax.swing.JOptionPane"%>
<%@page import="com.bs.themebridge.util.ThemeBridgeSimulator"%>
<%-- <%@page import="com.bs.themebridge.entity.adapter.impl.VerificationAdapterImpl"%> --%>
...
<%
	...
	if (requestInput != null && !requestInput.isEmpty()) {
		...
		if (psd) {
			error = false;
			//	bool = BridgeGateway.testGateway(request.getParameter("input"));
			bool = ThemeBridgeSimulator.processBridgeGatewaySimulator(request.getParameter("input"));
		} else {
			error = true;
		}
	}
					...
					<form method="POST" action="">
						<div class="col-sm-5">
							...
							<h3 style="color: #00aed7;">
								<font face="Times new roman">Bridge Gateway Request</font>
							</h3>
						...
						<div class="col-sm-1">
							<input class="btn btn-primary butpos" type="submit"
								...
								placeholder="paswd" required /> <br> <input
								class="btn btn-danger" type="reset" value="ClearAll" />
						</div>
						<div class=" col-sm-5">
							<!-- <h4>Gateway Response</h4> -->
							<h3 style="color: #00aed7;">
								<font face="Times new roman">Bridge Gateway Response</font>
							</h3>
