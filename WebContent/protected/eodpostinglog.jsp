...
<body>
	...
	<%
		//EodpostingAdapter epa = new EodpostingAdapter();
	...
	<%
		...
		Query searchQuery = tbe.entityManager.createQuery(
				"SELECT eodlog.id,eodlog.service,eodlog.operation,eodlog.masterreference,eodlog.eventreference,eodlog.status,eodlog.processtime FROM Eodposting eodlog "
						+ whereCondition);
	...
	<%
		...
		List<Object[]> eodpostingList = searchQuery.getResultList();
	...
	<div class="container">
		...
		<%
			if (eodpostingList != null && eodpostingList.size() == 0) {
		%>
		<div class="row">
					...
					<table id="configuration" class="display" cellspacing="0"
						...
						<tbody class="content">
							...
							<tr>
								...
								<td><a href="eodposting.jsp?id=<%=sd[0]%>"
