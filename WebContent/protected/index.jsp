		...
		<div id="section">
			...
			<div>
				...
				&emsp;&emsp;<a href="servicelog.jsp"> ServiceLog</a> &emsp;&emsp;<a
					href="transactionlog.jsp"> PostingsLog</a> &emsp;&emsp;<a
					href="eodpostinglog.jsp"> EODPostingLog</a> &emsp;&emsp;<a
					href="eodpostingstatus.jsp"> EODPostingStatus</a> &emsp;&emsp;<a
					href="notificationslog.jsp"> NotificationsLog</a> &emsp;&emsp;<a
					href="themestaginglog.jsp"> TransportLog</a>&emsp;&emsp;
			</div>
			<br>
			<div>
				<div id="foo">
				...
				&emsp;&emsp;<a href="lookupswiftdesc.jsp"> FuncedLiablity</a>
				&emsp;&emsp;
			</div>
			<br>
		</div>
