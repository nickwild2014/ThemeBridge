<%-- 
  ...
  - Description: Lookup Account type  
--%>
...
<%@page import="com.bs.themebridge.entity.model.LookupAccountType"%>
<%@page
	import="com.bs.themebridge.entity.adapter.LookupAccountTypeAdapter"%>
...
<title>Account Type Lookup</title>
...
<body>
	...
	<%
		LookupAccountTypeAdapter accTypeLookup = new LookupAccountTypeAdapter();
		List<LookupAccountType> accLookupList = accTypeLookup.getAllProperties();
	%>
	...
	<div class="container">
		...
		<%
			if (accLookupList != null && accLookupList.size() == 0) {
		%>
		<div class="row">
					...
					<table id="configuration" class="display" cellspacing="0"
						...
						<thead>
							<tr>
								...
								<th class="col-md-1" style="color: green">FI_Account_Type</th>
								<th class="col-md-4" style="color: green">Description</th>
							</tr>
						</thead>
						<tbody class="content">
							<%
								for (LookupAccountType sd : accLookupList) {									
							%>
							<tr>
								<td><%=sd.getZone()%></td>								
								<td><%=sd.getTiaccountype()%></td>
								<td><%=sd.getFiaccounttype()%></td>
