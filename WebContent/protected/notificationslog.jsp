<%-- 
  ...
  - Description: Notifications logging  
--%>
...
<body>
	...
	<%
		NotificationslogAdapter sda = new NotificationslogAdapter();
		...
		while (parameterNames.hasMoreElements()) {
			...
			if (!paramName.endsWith("daterange") && paramValue.trim().length() > 0)
				...
				whereCondition = whereCondition + " and " + prefix + "." + paramName + " like '" + paramValue + "'";//PRASATH
		}
	%>
	<!-- <%=whereCondition%> -->
	...
	<%
		...
		Query searchQuery = tbe.entityManager.createQuery(
				"SELECT slog.id,slog.service,slog.operation,slog.masterreference,slog.eventreference,slog.status,slog.processtime,slog.narrative1,slog.narrative2,slog.narrative3 FROM Notificationslog slog "
						+ whereCondition);
					...
					<table id="configuration" class="display" cellspacing="0"
						...
						<thead>
							<tr>
								...
								<th class="col-md-1" style="color: green">Step</th>
								<th class="col-md-1" style="color: green">StepStaus</th>
								<th class="col-md-1" style="color: green">User</th>
						...
						<tbody class="content">
							...
							<tr>
								...
								<td><a href="notifications.jsp?id=<%=sd[0]%>"
