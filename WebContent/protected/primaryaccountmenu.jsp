...
<script type="text/javascript">
	...
	if (hostname == "10.10.7.137") {// preprod Webserver
		globalName = "/tiplus2-global";

	} else if (hostname == "10.10.20.136") {//SIT Webserver
		globalName = "/tiplus2-global";

	} else if (hostname == "10.10.20.165") {// UTA3 webserver
		globalName = "/tiplus2-global";

	} else if (hostname == "misyswebappmig1" || hostname == "10.10.20.164") {
		globalName = "migration-global";
