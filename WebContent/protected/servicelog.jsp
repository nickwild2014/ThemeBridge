	...
	$(document)
			.ready(
					function() {
						...
						initFromDate = moment().format('DD-MM-YYYY');
						initToDate = moment().format('DD-MM-YYYY');
...
<script type="text/javascript" language="javascript">
	$(document).ready(function() {
		dropdownlist(localStorage.getItem("item1"));
	});

	function dropdownlist(listindex) {
		localStorage.setItem("item1", listindex);
		...
		case "TI":
			document.search.operation.options[0] = new Option(
					"<----operation----->", "");
			document.search.operation.options[1] = new Option("Swift Inward",
					"SwiftIn");
			document.search.operation.options[2] = new Option("SwiftIn ACK",
					"SwiftInAck");
			document.search.operation.options[3] = new Option("SwiftIn NAK",
					"SwiftInNak");
			document.search.operation.options[4] = new Option("SFMS Inward",
					"SFMSIn");
			document.search.operation.options[5] = new Option("SFMS ACK",
					"SFMSInAck");
			document.search.operation.options[6] = new Option("SFMS NAK",
					"SFMSInNak");
			document.search.operation.options[7] = new Option(
					"SFMS 298P Inward", "BEGIFN298P");
			break;
		...
		case "Limit":
			document.search.operation.options[0] = new Option(
					"<----operation----->", "");
			document.search.operation.options[1] = new Option("TreeView",
					"TreeView");
			document.search.operation.options[2] = new Option("Facilities",
					"Facilities");
			document.search.operation.options[3] = new Option("Reservations",
					"Reservations");
			...
			document.search.operation.options[5] = new Option(
					"ReservationsReversalR", "ReservationsReversalR");
			document.search.operation.options[6] = new Option(
					"ExposureReservation", "ExposureReservation");
			document.search.operation.options[7] = new Option(
					"ExposureReversal", "ExposureReversal");
			document.search.operation.options[8] = new Option(
					"ExposureReversalLCBD", "ExposureReversalLCBD");
			break;
		...
		case "EMAIL":
			...
			document.search.operation.options[7] = new Option("ServiceFailure",
					"ServiceFailure");
			document.search.operation.options[8] = new Option("SWIFTAdvice",
					"SWIFTAdvice");
			break;
		...
		case "Customization":
			...
			document.search.operation.options[3] = new Option("FD LienRemoval",
					"FDLienRemoval");
			document.search.operation.options[4] = new Option("CustAccEnquiry",
					"CustAccEnquiry");
			break;
		...
		case "TIEODJOB":
			document.search.operation.options[0] = new Option(
					"<----operation----->", "");
			document.search.operation.options[1] = new Option("BatchJobs",
					"BatchJobs");
			document.search.operation.options[2] = new Option("FXRATE",
					"FXRATE_HISTORY");
			document.search.operation.options[3] = new Option("BASERATE",
					"BASERATE_HISTORY");
			document.search.operation.options[4] = new Option("SPOTRATE",
					"SPOTRATE_HISTORY");
			document.search.operation.options[5] = new Option("REPORTS", "RPT");
			document.search.operation.options[6] = new Option("AML", "AML%");
			document.search.operation.options[7] = new Option("NPA", "NPA%");
			document.search.operation.options[8] = new Option("APMT", "APMT%");
			document.search.operation.options[9] = new Option("CIBIL", "CIBIL%");
			document.search.operation.options[10] = new Option("GLCMS",
					"GLCMS%");
			document.search.operation.options[11] = new Option("OFSAA",
					"OFSAA%");
			document.search.operation.options[12] = new Option("CALYPSO",
					"CALYPSO");
			document.search.operation.options[13] = new Option("RBIReports",
					"RBI%");
			document.search.operation.options[14] = new Option("BULK_POSTING",
					"BULK_POSTING");
			document.search.operation.options[15] = new Option("FDLienRemoval",
					"FDLienRemoval");
			document.search.operation.options[16] = new Option(
			...
			document.search.operation.options[19] = new Option("JobException",
					"JobException");
			document.search.operation.options[20] = new Option("ProcessStart",
					"ProcessStart");
			document.search.operation.options[21] = new Option("ProcessEnd",
					"ProcessEnd");
			break;
		}
		return true;
