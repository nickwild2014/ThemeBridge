...
<script type="text/javascript" language="javascript">
	function dropdownlist(listindex) {
		...
		case "GATEWAY":
			...
			document.search.operation.options[3] = new Option("RTGSILC",
					"RTGSILC");
			document.search.operation.options[4] = new Option("RTGSELC",
					"RTGSELC");
			document.search.operation.options[5] = new Option("RTGSBG",
					"RTGSBG");
			document.search.operation.options[6] = new Option("RTGSFSA",
					"RTGSFSA");
			document.search.operation.options[7] = new Option("NEFTILC",
					"NEFTILC");
			document.search.operation.options[8] = new Option("NEFTELC",
					"NEFTELC");
			document.search.operation.options[9] = new Option("NEFTBG",
					"NEFTBG");
			document.search.operation.options[10] = new Option("NEFTFSA",
					"NEFTFSA");
			document.search.operation.options[11] = new Option("EMAIL", "EMAIL");
			document.search.operation.options[12] = new Option("Swift Advice",
					"MailerAdvice");
			document.search.operation.options[13] = new Option("NCIFBGIS01",
					"NCIFBGIS01");
			break;
		...
		case "TIEOD":
			document.search.operation.options[0] = new Option(
					"<----operation----->", "");
			document.search.operation.options[1] = new Option("FXRATE",
					"FXRATE");
			document.search.operation.options[2] = new Option("BASERATE",
					"BASERATE");
			document.search.operation.options[3] = new Option("REPORTS",
					"REPORTS");
			break;
		...
		case "Customization":
			document.search.operation.options[0] = new Option(
					"<----operation----->", "");
			document.search.operation.options[1] = new Option("FDLienMark",
					"FDLienMark");
			document.search.operation.options[2] = new Option("FDLienEnquiry",
					"FDLienEnquiry");
			document.search.operation.options[3] = new Option("FDLienRemoval",
					"FDLienRemoval");
			break;
...
<body>
	...
	<%
		...
		if (serviceParameter == null)
			serviceParameter = "";
		if (serviceParameter.trim().equals("TIEOD"))
			tieodSelected = "SELECTED";
		...
		String prefix = "ttlog";
		String whereCondition = " Where " + prefix + "." + "receivedtime" + " <= " + ":rangeEnd" + " and " + prefix
				+ "." + "receivedtime" + " >= " + ":rangeStart";
	...
	<%
		...
		Query searchQuery = tbe.entityManager.createQuery(
				"SELECT ttlog.id, ttlog.service, ttlog.operation, ttlog.status, ttlog.receivedtime FROM Themetransportclientlog ttlog "
						+ whereCondition);
			...
			<div class="col-md-9">
				<div class="row">
					<table id="configuration" class="display" cellspacing="0"
						...
						<thead>
							<tr>
								<th class="col-md-1" style="color: green">ID</th>
								...
								<th class="col-md-2" style="color: green">ReceivedTime</th>
						...
						<tbody class="content">
							...
							<tr>
								...
								<td><a href="themestaging.jsp?id=<%=sd[0]%>"
						...
						<div class="form-group">
							...
							<div class="col-md-8">
								<select name="service" class="form-control" id="service"
									...
									<option value="TIEOD" <%=tieodSelected%>>TIEOD</option>
									<option value="EODJOB" <%=eodjobSelected%>>EODJOB</option>
