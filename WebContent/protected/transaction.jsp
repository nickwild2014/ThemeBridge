		...
		<div class="row">
			<%
				if (request.getParameter("id") != null) {
					...
					Transactionlog tl = sda.getKeyProperty(id);
			%>
			...
			<div class="row">
				<div class="col-sm-12 col-md-12 col-lg-12">
					...
					<%-- <div class="col-lg-1">
						<h5>Log ID</h5>
						<input type="text" class="form-control" id="status"
							spellcheck="false" readonly="readonly" value="<%=tl.getId()%>" />
					</div> --%>
				</div>
			</div>
			<!-- <br> -->
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<textarea class="form-control" id="tirequest" cols="80"
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<textarea class="form-control" id="tiresponse" cols="80"
					...
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<textarea class="form-control" id="bankrequest" cols="80"
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<textarea class="form-control" id="bankresponse" cols="80"
