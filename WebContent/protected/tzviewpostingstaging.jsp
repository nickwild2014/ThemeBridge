<%-- 
  ...
  - Description: View Posting staging log  
--%>
				...
				<div class="container">
					<%
						if (request.getParameter("id") != null) {
							...
							Postingstaging tl = sda.getKeyProperty(id);
					%>
					<div class="row">
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="col-lg-2">
								...
								<input type="text" class="form-control" id="source"
									spellcheck="false" readonly="readonly" value="ZONE1" />
							</div>
							<div class="col-lg-2">
								<h5>Service</h5>
						...
						<div class="col-sm-12 col-md-12 col-lg-12">
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<textarea id="tirequest" class="form-control" cols="80"
									rows="14" spellcheck="false" readonly><%=tl.getTirequest()%></textarea>
							</div>
							...
							<div class="col-sm-6 col-md-6 col-lg-6">
								...
								<textarea id="tiresponse" class="form-control" cols="80"
									rows="14" spellcheck="false" readonly="readonly"><%=tl.getTiresponse()%></textarea>
							</div>
						</div>
					</div>
					<br> <br>
					...
					<%-- <div class="row">
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="row">
								...
								<div class="col-sm-8 col-md-8 col-lg-8 consoleTime">
									<h5>
										<span>Request Time : <%=DateTimeUtil.getStringDateByDateInFormat(tl.getProcesstime(), "yyyy-MM-dd HH:mm:ss")%></span>
									</h5>
								</div>
							</div>
							<textarea id="bankrequest" class="form-control" cols="80"
								rows="14" spellcheck="false" readonly="readonly">STOPPED</textarea>
						</div>
						<div class="col-sm-6 col-md-6 col-lg-6">
							<div class="row">
								<div class="col-sm-4 col-md-4 col-lg-4">
	...
	<script type='text/javascript'>
		function saveTextAsFile() {
			...
			var textToWrite = "Source : ThemeBridge\n" + "\nZONE ID: "
					...
					+ "\nMaster Reference : "
					+ document.getElementById("masterreference").value
					+ "\nEvent Reference : "
					+ document.getElementById("eventreference").value
					+ "\nOperation : "
			...
			// alert('1');
			var fileNameToSaveAs = document.getElementById("masterreference").value
					+ "-" + document.getElementById("eventreference").value;
