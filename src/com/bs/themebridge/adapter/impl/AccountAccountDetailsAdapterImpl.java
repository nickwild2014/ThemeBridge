...
import static com.bs.themebridge.util.ThemeConstant.OPERATION_ACCOUNTDETAILSEARCH;
...
public class AccountAccountDetailsAdapterImpl extends ServiceAdapterImpl {
	...
	public String process(String inputXml) throws ClassNotFoundException {
		logger.debug("Request enters AccountAccountDetails Adapter");
	...
	public static String getErrorResponse(String errorMessage) {
		...
		if (ValidationsUtil.isValidString(errorMessage)) {
			responseHeader = ResponseHeaderUtil.failedResponse(SERVICE_ACCOUNT, OPERATION_ACCOUNTDETAILSEARCH, "", "",
					errorMessage + " (IM)");
	...
	public AdapteeInterface getAdapteeInstance(String inputXml) {
		...
		AdapteeInterface implementationClass = AdapteeUtil.getAdapteeInstance(inputXml,
				AdapteeImplementation.getAccountaccountdetailsadaptee());
