...
public class GATEWAYNEFTRTGSAdapterImpl extends ServiceAdapterImpl {

	private final static Logger logger = Logger
			.getLogger(GATEWAYNEFTRTGSAdapterImpl.class);

	@Override
	public String process(String inputXml) throws ClassNotFoundException {

		logger.info(" ************ GATEWAY.NEFTRTGS Adapter Impl started ************ ");
		AdapteeInterface serviceAdaptee = null;
		String result = "";
		try {
			logger.debug("Initiate GATEWAY.NEFTRTGS Adaptee");
	...
	public AdapteeInterface getAdapteeInstance(String inputXml) {
		...
		AdapteeInterface implementationClass = AdapteeUtil.getAdapteeInstance(
				inputXml, AdapteeImplementation.getNeftrtgsadaptee());
