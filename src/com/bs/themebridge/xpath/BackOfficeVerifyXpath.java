...
public class BackOfficeVerifyXpath {

	// Bank response
	public static final String HostStataus = "FIXML/Header/ResponseHeader/HostTransaction/Status";
	public static final String ServiceStataus = "FIXML/Body/executeFinacleScriptResponse/executeFinacleScript_CustomData/STATUS";
	...
	public static final String FIBusinessExCode = "FIXML/Body/Error/FIBusinessException/ErrorDetail/ErrorCode";
	public static final String FIBusinessExMsgDesc = "FIXML/Body/Error/FIBusinessException/ErrorDetail/ErrorDesc";
	public static final String FIBusinessExErrorSource = "/FIXML/Body/Error/FIBusinessException/ErrorDetail/ErrorSource";
	public static final String FIBusinessExErrorType = "/FIXML/Body/Error/FIBusinessException/ErrorDetail/ErrorType";
	// Failure
	public static final String FIScriptResponseExCode = "FIXML/Body/executeFinacleScriptResponse/executeFinacleScript_CustomData/Error_Code";
	public static final String FIScriptResponseExMsgDesc = "FIXML/Body/executeFinacleScriptResponse/executeFinacleScript_CustomData/Error_Msg";

	public static final String SuccessMessageDesc = "FIXML/Body/executeFinacleScriptResponse/executeFinacleScript_CustomData/MESSAGE";
